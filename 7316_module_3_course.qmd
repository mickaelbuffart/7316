...
subtitle: "MODULE 3: Describing data."
...
Now, you know how to import data, create and clean a dataset. In this module, we will learn how to describe a dataset with visuals and with summary statistics.
...
![Example of ggplot2 graph, with SSE stylesheet](assets/images/04_01_graph_example.png){fig-align="center" width="400"}
...
![New RMarkdown file](assets/images/05_06_new_rmd.png){fig-align="center" width="400"}
...
![New Quarto file](assets/images/05_07_rmarkdown_default.png){fig-align="center" width="400"}
...
![Some YAML options in quarto](assets/images/yaml.png){fig-align="center" width="529"}
...
![Example of empty code chunk](assets/images/code_chunk.png)
